...
import ch8.instructions.constants.*;
import ch8.instructions.loads.aaload.*;
import ch8.instructions.loads.lload.*;
import ch8.instructions.loads.aload.*;
import ch8.instructions.loads.dload.*;
import ch8.instructions.loads.fload.*;
import ch8.instructions.loads.iload.*;
import ch8.instructions.stores.aastore.*;
import ch8.instructions.stores.astore.*;
import ch8.instructions.stores.dstore.*;
import ch8.instructions.stores.fstore.*;
import ch8.instructions.stores.istore.*;
import ch8.instructions.stores.lstore.*;
import ch8.instructions.stack.pop.*;
import ch8.instructions.stack.dup.*;
import ch8.instructions.stack.swap.SWAP;
import ch8.instructions.math.iinc.IINC;
import ch8.instructions.math.add.*;
import ch8.instructions.math.and.*;
import ch8.instructions.math.div.*;
import ch8.instructions.math.mul.*;
import ch8.instructions.math.sub.*;
import ch8.instructions.math.neg.*;
import ch8.instructions.math.or.*;
import ch8.instructions.math.rem.*;
import ch8.instructions.math.sh.*;
import ch8.instructions.math.xor.*;
import ch8.instructions.comparisons.ifcond.*;
import ch8.instructions.comparisons.if_acmp.*;
import ch8.instructions.comparisons.xcmp.*;
import ch8.instructions.comparisons.if_icmp.*;
import ch8.instructions.control.*;
import ch8.instructions.conversions.d2x.*;
import ch8.instructions.conversions.f2x.*;
import ch8.instructions.conversions.i2x.*;
import ch8.instructions.conversions.l2x.*;
import ch8.instructions.extended.*;
import ch8.instructions.references.*;
