...
import ch7.instructions.constants.*;
import ch7.instructions.loads.lload.*;
import ch7.instructions.loads.aload.*;
import ch7.instructions.loads.dload.*;
import ch7.instructions.loads.fload.*;
import ch7.instructions.loads.iload.*;
import ch7.instructions.stores.astore.*;
import ch7.instructions.stores.dstore.*;
import ch7.instructions.stores.fstore.*;
import ch7.instructions.stores.istore.*;
import ch7.instructions.stores.lstore.*;
import ch7.instructions.stack.pop.*;
import ch7.instructions.stack.dup.*;
import ch7.instructions.stack.swap.SWAP;
import ch7.instructions.math.iinc.IINC;
import ch7.instructions.math.add.*;
import ch7.instructions.math.and.*;
import ch7.instructions.math.div.*;
import ch7.instructions.math.mul.*;
import ch7.instructions.math.sub.*;
import ch7.instructions.math.neg.*;
import ch7.instructions.math.or.*;
import ch7.instructions.math.rem.*;
import ch7.instructions.math.sh.*;
import ch7.instructions.math.xor.*;
import ch7.instructions.comparisons.ifcond.*;
import ch7.instructions.comparisons.if_acmp.*;
import ch7.instructions.comparisons.xcmp.*;
import ch7.instructions.comparisons.if_icmp.*;
import ch7.instructions.control.*;
import ch7.instructions.conversions.d2x.*;
import ch7.instructions.conversions.f2x.*;
import ch7.instructions.conversions.i2x.*;
import ch7.instructions.conversions.l2x.*;
import ch7.instructions.extended.*;
import ch7.instructions.references.*;
