...
import ch6.instructions.constants.*;
import ch6.instructions.loads.lload.*;
import ch6.instructions.loads.aload.*;
import ch6.instructions.loads.dload.*;
import ch6.instructions.loads.fload.*;
import ch6.instructions.loads.iload.*;
import ch6.instructions.stores.astore.*;
import ch6.instructions.stores.dstore.*;
import ch6.instructions.stores.fstore.*;
import ch6.instructions.stores.istore.*;
import ch6.instructions.stores.lstore.*;
import ch6.instructions.stack.pop.*;
import ch6.instructions.stack.dup.*;
import ch6.instructions.stack.swap.SWAP;
import ch6.instructions.math.iinc.IINC;
import ch6.instructions.math.add.*;
import ch6.instructions.math.and.*;
import ch6.instructions.math.div.*;
import ch6.instructions.math.mul.*;
import ch6.instructions.math.sub.*;
import ch6.instructions.math.neg.*;
import ch6.instructions.math.or.*;
import ch6.instructions.math.rem.*;
import ch6.instructions.math.sh.*;
import ch6.instructions.math.xor.*;
import ch6.instructions.comparisons.ifcond.*;
import ch6.instructions.comparisons.if_acmp.*;
import ch6.instructions.comparisons.xcmp.*;
import ch6.instructions.comparisons.if_icmp.*;
import ch6.instructions.control.*;
import ch6.instructions.conversions.d2x.*;
import ch6.instructions.conversions.f2x.*;
